-- Permite configurar o evento antes dos ingressos. Preserva locks, identidade e ACL.
BEGIN;
SET LOCAL lock_timeout = '3s';
SET LOCAL statement_timeout = '30s';
DO $preflight$
BEGIN
 IF md5(pg_get_functiondef('public.producao_acesso_ativar_qr_evento(text,text,text,text,uuid)'::regprocedure)) <> '90a2d1b999b9d76b4d4965d8c364d84d' THEN
