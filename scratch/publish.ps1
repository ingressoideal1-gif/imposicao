...
git add -A
git commit -m "fix: renderizacao da janela do verso para numeracao duplex e renomeacao para NewProd Agent (v$nextV)"
...
Write-Host "SUCESSO! v$nextV publicada no ar!"
