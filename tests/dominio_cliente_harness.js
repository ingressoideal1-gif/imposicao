...
(async () => {
    for (const origin of ['https://ideal-imposition.vercel.app', 'http://127.0.0.1:9000', 'https://imposition.ai-ideal.com.br']) {
        for (const existing of [true, false]) {
            const row = { id: 1, os_id: 'teste', numero_pedido: '900', token: 'abc123', ativo: true };
            const query = {
                select() { return this; },
                eq() { return this; },
                update() { return this; },
            ...
            await assert.rejects(() => ctx.getOrCreateLinkCliente('teste', '900'));
        }
    }
