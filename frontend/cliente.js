                            ...
                            <div style="text-align: center; display: flex; flex-direction: column; align-items: center; width: 100%;">
                                ...
                                <div id="amostra-pdf-viewer-${idx}" style="text-align: center;">
                                    <!-- 450px, o MESMO teto do canvas do verso logo abaixo (02/09/2026).
                                         ...
                                         setas do folheador. -->
                                    <span class="amostra-arte-lugar"><canvas id="amostra-pdf-canvas-${idx}" style="max-width: 100%; max-height: 450px; object-fit: contain; margin: 0 auto; display: none; box-shadow: var(--shadow); background: #ffffff; cursor: zoom-in;" onclick="openClienteLightbox('amostra-pdf-canvas-${idx}')"></canvas>${ampliar}</span>
